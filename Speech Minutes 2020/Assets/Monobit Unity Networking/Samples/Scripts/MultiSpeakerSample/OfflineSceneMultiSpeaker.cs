...
public class OfflineSceneMultiSpeaker : MonobitEngine.MonoBehaviour
{
	// シーンファイル名
	public static readonly string SceneNameOffline = "OfflineSceneMultiSpeaker";
	public static readonly string SceneNameOnline = "OnlineSceneMultiSpeaker";
